...
public interface DefineMethod<C, R> extends Implementable<C, R>, Annotatable<DefineMethod<C, R>>
{
    ...
    {
        <P> DefineArgs1<C, R, P> param(TypeProxy<P> paramClass);

        default <P> DefineArgs1<C, R, P> param(Class<P> paramClass)
        {
            return param(TypeProxy.of(paramClass));
        }
    }

    public interface DefineArgs1<C, R, P0> extends DefineParam<C, R, P0, DefineArgs1<C, R, P0>>
    {
        <P> DefineArgs2<C, R, P0, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs3<C, R, P0, P1, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs4<C, R, P0, P1, P2, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs5<C, R, P0, P1, P2, P3, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs6<C, R, P0, P1, P2, P3, P4, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs7<C, R, P0, P1, P2, P3, P4, P5, P> param(TypeProxy<P> paramClass);
    ...
    {
        <P> DefineArgs8<C, R, P0, P1, P2, P3, P4, P5, P6, P> param(TypeProxy<P> paramClass);
